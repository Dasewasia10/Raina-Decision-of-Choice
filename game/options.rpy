...
define config.name = _("Raina Decision of Choice")
...
## Choice Menu agar bisa diisi selain dengan kelipatannya pada VPGrid
...
define build.name = "RainaDecisionofChoice"
...
## tersedia. jika "auto", jendelaew di sembunyikan sebelum pernyataan scene dan di
...
define config.save_directory = "RainaDecisionofChoice-1662045567"
...
init python:
    ...
    build.classify("game/images/BG/**.png", "archive")
    build.classify("game/images/BG/**.jpg", "archive")
    
    build.classify("game/images/CG/**.png", "archive")
    build.classify("game/images/CG/**.jpg", "archive")
    
    build.classify("game/images/Raina/**.png", "archive")
    build.classify("game/images/Raina/**.jpg", "archive")
    
    build.classify("game/images/sample/**.png", None)
    build.classify("game/images/sample/**.jpg", None)

    ## Archive file .mp3 dan .ogg
    build.classify("game/**.mp3", "archive")
    build.classify("game/**.ogg", "archive")
    build.classify('game/**.wav', 'archive')
    
    ## Archive file .rpy, .rpyc dan .rpa
    build.classify('game/**.rpy', 'archive')
    build.classify('game/**.rpyc', 'archive')
    build.classify('game/**.rpa', 'archive')
    
    ## Archive file fonts .ttf dan .otf
    build.classify("game/fonts/**.ttf", "archive")
    build.classify('game/fonts/**.otf', 'archive')
